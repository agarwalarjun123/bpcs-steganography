...
public class Payload {
	...
	int fileSize;
	MimeType filetype;
	static MimeType[] ALLOWED_MIMETYPES = {MimeType.TXT, MimeType.PNG, MimeType.JPEG, MimeType.PDF,MimeType.DOCX};
	...
	int conjugateBlocksCount() {
		return (int) Math.ceil(this.blocks.size() / 64.0);
	}
