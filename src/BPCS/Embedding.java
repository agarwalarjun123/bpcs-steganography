...
public class Embedding {
	...
	void outputFile() throws IOException {
		...
		ImageIO.write(img1, this.im.filetype.getExtension(), new File("./output/stego." + this.im.filetype.getExtension()));
		System.out.println("Stego Object created at output/stego." + this.im.filetype.getExtension());
	}
